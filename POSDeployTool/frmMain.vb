...
Public Class frmMain
    ...
    Private ReadOnly _configService As New StoreConfigService()
    Private ReadOnly _connectionService As New ConnectionCheckService()
    Private ReadOnly _backupService As New BackupService()
    Private ReadOnly _deployService As New DeployService()
    Private ReadOnly _validationService As New PreDeployValidationService()
    Private ReadOnly _retryService As New RetryService()
    Private ReadOnly _historyService As New DeploymentHistoryService()
    Private ReadOnly _versionService As New VersionService()
    Private ReadOnly _remoteInfoService As New RemoteSystemInfoService()
    Private ReadOnly _remoteToolsService As New RemoteToolsService()
    Private ReadOnly _healthService As New HealthCheckService()
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtConfigPath.Text = Path.Combine(
            AppDomain.CurrentDomain.BaseDirectory,
            "Config",
            "stores.json"
        )

        txtPackagePath.Text = Path.Combine(
            AppDomain.CurrentDomain.BaseDirectory,
            "Release",
            "BJCBCPOS"
        )
